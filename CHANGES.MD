3.4.2 (2021-10-06)
=================
- Add support for `$account_number_last5`, `$account_holder_name`, `$bank_name`, `$bank_country`, `$shortened_iban_first6`, `$shortened_iban_last4`, and `$sepa_direct_debit_mandate` to `$payment_method` complex field
