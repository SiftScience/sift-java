...
public class CreateMerchantTest {
    ...
    public void testCreateMerchant() throws Exception {
        ...
        CreateMerchantRequest request = client.buildRequest(
                new CreateMerchantFieldSet().setId("api-key-1")
        ...
        CreateMerchantResponse siftResponse = request.send();

        // Verify the request.
        RecordedRequest request1 = server.takeRequest();
        Assert.assertEquals("POST", request1.getMethod());
        Assert.assertEquals("/v3/accounts/YOUR_ACCOUNT_ID/psp_management/merchants", request1.getPath());
